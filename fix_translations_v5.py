    ...
    while i < len(lines):
        ...
        if line.startswith('msgid "'):
            ...
            if line == 'msgid ""':
                ...
                msgid_lines.append(msgid_content)
                i += 1
...
if __name__ == '__main__':
    ...
    # 验证
    count2 = check_remaining_empty()
    print(f"剩余空翻译: {count2}")
